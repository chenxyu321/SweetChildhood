			...
			<div class="intro-content">
				<div class="slider-content">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="layer-1 wow fadeInUp" data-wow-delay="0.3s">
								    <h6 class="best-title">${Chengguo[0].text}</h6>
									<h2 class="title2">${Chengguo[0].time}</h2>
								</div>
								<!-- layer 2 -->
						...
						<c:forEach items="${Chengguophoto}" var="p">
							<div><img src="${p.photopath}" alt="成果图片"  width="200px" height="200px"></div>
						</c:forEach>
					</div>
				</div>
			</div>
